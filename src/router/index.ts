...
import { Layout, Block, getParentLayout } from '@/utils/routerHelper'
        ...
        children: [
          {
            path: 'default-table',
            component: () =>
              import('@/views/Components/Table/DefaultTable.vue'),
            name: 'DefaultTable',
            meta: {
          ...
          },
          {
            path: 'use-table',
            component: () =>
              import('@/views/Components/Table/UseTableDemo.vue'),
            name: 'UseTable',
            meta: {
              title: 'UseTable',
            },
...
export const effectRouterMap: AppRouteRecordRaw[] = [
  {
    path: '/directive',
    component: Layout,
    name: 'Directive',
    meta: {
      icon: 'ep:management',
      title: t('router.directive'),
    },
    redirect: '/directive/disabled',
    children: [
      {
        path: 'disabled',
        component: () => import('@/views/Directive/Disabled/index.vue'),
        name: 'Disabled',
        meta: {
          title: t('router.disabled'),
          noCache: true,
          affix: true,
        },
        children: [
          {
            path: 'detail/:type',
            component: () => import('@/views/Directive/Disabled/Detail.vue'),
            name: 'Detail',
            meta: {
              hidden: true,
    ...
    children: [
      {
        ...
        component: () => import('@/views/CSS3/H5/ScrollSnapType/Index.vue'),
        name: 'ScrollSnap',
        meta: {
  ...
  },
  {
    ...
    name: 'Composition',
    meta: {
      title: t('router.composition'),
    },
    children: [
      {
        path: 'select2select',
        component: () => import('@/views/Composition/select2select/Index.vue'),
        name: 'Select',
        meta: {
          title: t('router.composition'),
        },
  ...
  },
  {
    ...
    children: [
      {
        path: 'digital',
        component: () => import('@/views/Gsap/Digital/Index.vue'),
        name: 'Digital',
        meta: {
          title: t('router.digital'),
        },
      },
      {
        path: 'list',
        component: () => import('@/views/Gsap/List/Index.vue'),
        name: 'List',
        meta: {
          title: t('router.list'),
        },
      ...
      {
        path: 'starter',
        component: () => import('@/views/Gsap/Starter/Index.vue'),
        name: 'Starter',
        meta: {
          title: t('router.starter'),
        },
      },
      {
        path: 'tab',
