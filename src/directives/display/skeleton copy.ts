...
import { reactive, watchEffect, render, h } from 'vue'
...
// Define the Vue3 directives
const directives = {
  skeleton: Skeleton,
  'skeleton-item': SkeletonItem,
  'skeleton-style': SkeletonStyle,
  'skeleton-item-style': SkeletonItemStyle,
}

export const setupSkeletonDirective = (app: App<Element>) => {
