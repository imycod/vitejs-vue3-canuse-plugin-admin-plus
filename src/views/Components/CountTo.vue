...
<template>
  <ContentWrap
    :title="t('countToDemo.countTo')"
    :message="t('countToDemo.countToDes')"
  >
    ...
    <ElRow :gutter="20" justify="space-between">
      <ElCol :xl="8" :lg="8" :md="12" :sm="24" :xs="24">
        <div class="flex mb-20px items-center">
          <span class="min-w-90px text-right"
            >{{ t('countToDemo.startVal') }}：</span
          >
